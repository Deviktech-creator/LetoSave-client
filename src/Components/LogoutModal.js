    ...
    return (
        <Modal show={show} onHide={onClose} centered>
            ...
            <Modal.Footer className='border-0 d-flex justify-content-center mb-4'>
                ...
                <Link to="/login" variant="danger" className='px-5 py-2 text-decoration-none text-white rounded' style={{backgroundColor:"#064FB8", border:"1px solid black"}} onClick={onLogout}>Yes</Link>
            </Modal.Footer>
        </Modal>
    );
};
